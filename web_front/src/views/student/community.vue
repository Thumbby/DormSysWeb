    ...
    methods: {
        ...
        sendComment(){
            if(!this.replyComment){
                ...
                let timeFormat = this.$moment(new Date().getTime()).format();
        ...
        dateStr(date){
            ...
            if(time<60*10){//十分钟内
                ...
                //超过30天ddd
                var over_date= new Date(parseInt(date));
                return over_date.getFullYear()+"/"+(over_date.getMonth()+1)+"/"+over_date.getDate();
            }
        }
    },    
}
